        ...
        <div className='bg-fundoGeral'>
            <header className='absolute inset-x-0 top-0 z-50'>
                <nav className='flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
                    ...
                    <div className='hidden lg:flex lg:gap-x-12'>
                        <ScrollLink to='sobre' spy={true} smooth={true} className='cursor-pointer text-base font-semibold leading-6 text-white'>SOBRE</ScrollLink>
                        <ScrollLink to='sobremimsm' spy={true} smooth={true} className='cursor-pointer text-base font-semibold leading-6 text-white'>SOBRE MIM</ScrollLink>
                        <ScrollLink to='instagram' spy={true} smooth={true} className='cursor-pointer text-base font-semibold leading-6 text-white'>INSTAGRAM</ScrollLink>
                            ...
                            <div className='mt-6 flow-root'>
                                <div className='-my-6 divide-y divide-gray-50/200'>
                                    <div className='space-y-2 py-6'>
                                        <ScrollLink to='sobre' spy={true} smooth={true} className='cursor-pointer -mx-3 block rounded-lg px-3 py-2 text-xl font-semibold leading-7 text-gray-100 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>SOBRE</button></ScrollLink>
                                        <ScrollLink to='sobremim' spy={true} smooth={true} className='cursor-pointer -mx-3 block rounded-lg px-3 py-2 text-xl font-semibold leading-7 text-gray-100 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>SOBRE MIM</button></ScrollLink>
                                        <ScrollLink to='instagram' spy={true} smooth={true} className='cursor-pointer -mx-3 block rounded-lg px-3 py-2 text-xl font-semibold leading-7 text-gray-100 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>INSTAGRAM</button></ScrollLink>
                                        <ScrollLink to='contato' spy={true} smooth={true} className='cursor-pointer -mx-3 block rounded-lg px-3 py-2 text-xl font-semibold leading-7 text-gray-100 hover:bg-gray-50'><button onClick={() => setIsSidebarOpen(false)}>CONTATO</button></ScrollLink>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className='relative isolate overflow-hidden pt-14'>
                ...
                <Link to='/#empresa' className='text-sm font-semibold leading-6 text-white'>Saiba mais <span aria-hidden='true'>→</span></Link>
                        ...
                        <div className='mt-10 flex items-center justify-center gap-x-6'>
                            <Link to={URLS.instagram} className='cursor-pointer text-gray-400 hover:text-gray-500'>
                            ...
                            <Link to={URLS.tiktok} className='cursor-pointer text-gray-500 hover:text-gray-400'>
                            ...
                            <Link to={URLS.youtube} className='cursor-pointer text-gray-400 hover:text-gray-500'>
