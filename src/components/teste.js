...
const Formulario = () => {
    return (
        ...
        <div className='isolate px-6 -mt-10 mb-20 lg:px-8 font-montserrat'>
            ...
            <form action='https://formsubmit.co/alanaandreazza26@gmail.com' method='POST' className='mx-auto mt-16 max-w-xl sm:mt-20 rounded-3xl p-8 ring-2 bg-black shadow-2xl'>
