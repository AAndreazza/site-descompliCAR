        ...
        <div className='bg-gray-900 pb-20 sm:pb-24 xl:pb-0 mt-10'>
          <div className='mx-auto flex flex-col-reverse items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:items-stretch xl:flex-row-reverse'>
            ...
            <div className='w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24'>
              <figure className='relative isolate pt-10 sm:pt-12 text-center'>
                <svg
                  viewBox='0 0 162 128'
                  fill='none'
                  aria-hidden='true'
                  className='absolute left-0 top-10 lg:top-0 -z-10 h-32 stroke-white/20'
                >
                  <path
                ...
                <figcaption className='mt-8 text-base'>
                  <div className='font-semibold text-white'>Vinicius Boing</div>
                  <div className='mt-1 text-gray-400'>Criador do DescompliCAR</div>
                </figcaption>
              </figure>
            </div>
          </div>
