...
const FaqSection = () => {
  return (
    <div className="relative isolate overflow-hidden bg-fundoGeral px-4 py-10 text-center sm:px-56">
      <h2 className='py-2 text-xl font-semibold leading-8 text-gray-100 sm:text-4xl sm:leading-9'>Perguntas Frequentes</h2>
      <h4 className='text-base leading-8 text-gray-300 sm:text-lg sm:leading-9 hover:text-gray-100'><Link to={getWhatsUrl(CTA_WHATSAPP_MENSAGENS.ctaGeral)}>Tem mais alguma pergunta? Estamos aqui para te ajudar <span aria-hidden="true">&rarr;</span></Link></h4>
      ...
      <Disclosure>
        {({ open }) => (
          <>
            ...
            <Disclosure.Panel className="px-4 pt-4 pb-2 text-lg text-gray-200">
