      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="flex flex-col justify-between rounded-3xl bg-gray-300 p-8 ring-1 ring-gray-600 xl:p-10 lg:mt-0 mr-4">
            <div className="flex items-center justify-between gap-x-4">
              <h3 id="tier-startup" className="text-xl ml-12 text-center font-bold text-gray-900">Plano de manutenção</h3>
            </div>
          ...
          <div className="flex flex-col justify-between rounded-3xl bg-gray-300 p-8 ring-1 ring-gray-600 xl:p-10 lg:mt-0 mr-4">
            <div className="flex items-center justify-between gap-x-4">
              <h3 id="tier-startup" className="text-xl ml-12 text-center font-bold text-gray-900">Análise de orçamentos</h3>
            </div>
            <div className='mt-6 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-2xl lg:aspect-none group-hover:opacity-75'>
          ...
          <div className="flex flex-col justify-between rounded-3xl bg-gray-300 p-8 ring-1 ring-gray-600 xl:p-10 lg:mt-0 mr-4">
            <div className="flex items-center justify-between gap-x-4">
              <h3 id="tier-startup" className="text-xl ml-1.5 text-center font-bold text-gray-900">Avaliação de desgaste de peças</h3>
            </div>
            <div className='mt-6 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-2xl lg:aspect-none group-hover:opacity-75'>
